...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = const Color(0xff9AC0CD),
    ...
    Color backArrowColor = const Color(0xff9AC0CD),
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = const Color(0xff9AC0CD),
    ...
    Color verticalBarColor = const Color(0xff9AC0CD),
