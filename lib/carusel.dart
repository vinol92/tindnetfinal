...
class CarousselTindNet extends StatefulWidget {
  Usuario user;
  CarousselTindNet({super.key, required this.user});

  @override
  State<CarousselTindNet> createState() => _CarousselTindNetState();
}
...
class _CarousselTindNetState extends State<CarousselTindNet> {
  @override
